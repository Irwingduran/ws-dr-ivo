        ...
        <>
            <div className='flex flex-col sm:flex-row items-start gap-[35px] py-[70px]'>
                ...
                <SlideInFromLeft className='flex flex-col items-start gap-[35px] sm:order-1'>
                   ...
                   <a href="https://wa.me/5212226398763?text=Hola%20doctor,%20encontré%20su%20contacto%20en%20su%20sitio%20web%20y%20me%20gustaría%20agendar%20una%20cita" target='_blank'> <button className='bg-[#0284C7] text-white text-[20px] px-4 py-2 rounded-lg'>Agendar Cita</button></a>
                </SlideInFromLeft>
            </div>
